    ...
    <>
      ...
      <h2 className="mb-8 text-5xl font-light leading-tight tracking-tighter">
        contact me
          ...
          <br/>
          <a href="mailto:clp@clp.is"><button class="px-5 py-3 rounded-lg shadow bg-green-500 text-white mr-4">Email me (personal)</button></a>

          <a href="mailto:chris@devisa.io"><button class="px-5 py-3 rounded-lg shadow bg-white-500 text-black">Email me (business)</button></a>
          <br/><br/>
